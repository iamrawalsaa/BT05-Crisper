...
namespace BT05
{
    ...
    public sealed class ArduinoManager
    {
        ...
        public void OpenFirstSerialPort()
        {
            ...
            {
                string match = Game1.Instance.Config.ComPort; // This PC
                //string match = "COM4"; // Main PC
                ...
                if (sections.Length == 2)
                {
                    ...
                    if (string.Compare(command, "WAVE", true) == 0)
                    {
                        if (MyScreenManager.Instance.CurrentScreen != null)
                        {
                            ...
                            MyScreenManager.Instance.CurrentScreen.WavedInGame();
                        }
                    }

                    // :H: Updating language if current screen is language selection screen only
                    ...
                    if (screenLanguage != null)
                    {
                        ...
                        {
                            //if (string.Compare(parameter, "ENGLISH", true) == 0) // :H: Inverted language due to hardware
                            ...
                            //if (string.Compare(parameter, "HINDI", true) == 0) // :H: Inverted language due to hardware
