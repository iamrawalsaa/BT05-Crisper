...
namespace SharedMonoGame
{
    ...
    public abstract class GameScreenExtended : GameScreen
    {
        ...
        internal bool _isWavedInGame = false;
        internal bool _isAttractScreenVisible = false;
        ...
        public void WavedInGame()
        {
            if (_isWavedInGame)
            {
                LogManager.Instance.hasSkipped = true;
                _isWaveValid = false;
                _isAttractScreenVisible = true;
                //ScreenGame.Instance.SkipWaved();
                _isWavedInGame = false;
            }
        }
        ...
        public virtual void ScreenArriving()
        {
            ...
            if (_defaultAnimation1 != null)
            {
                _defaultAnimation1.Reset();
            }
        }
        ...
        public virtual void DrawSecondScreenInner(GameTime gameTime)
        {
            if (_defaultAnimation1 != null)
            {
                _defaultAnimation1.DrawSpriteSheetAnim();
            }
        }
        ...
        protected OnScreenAnimation _defaultAnimation1;
    }
}