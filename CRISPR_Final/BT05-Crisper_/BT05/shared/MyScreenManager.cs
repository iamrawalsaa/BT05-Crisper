...
namespace SharedMonoGame
{
    public sealed class MyScreenManager
    {
        ...
        void CreateAllScreens(MyGameBase game)
        {
            ...
            //_gameScreens.Add(GamePhase.ENDGAME, new ScreenSummaryGame(game, GamePhase.ENDGAME)); // :H: Removed score screen
            ...
            //_gameScreens.Add(GamePhase.PROTOTYPEMESSAGES, new ScreenPrototypeMessages(game, GamePhase.PROTOTYPEMESSAGES)); // :H: Removed prototype screen
