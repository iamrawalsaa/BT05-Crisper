...
namespace screens
{
    public partial class ScreenGame : GameScreenExtended
    {
        ...
        public override void ScreenArriving()
        {
            ...
            _timeInState = 200f; // :H: used to change the timer
            LogManager.Instance.LanguageText = LogLanguage();
            _timeToSkip = 10f;
            ...
            LoadContentOnce();  // :H: Added for scissor language updation
        ...
        public override void LoadContent()
        {
            ...
            var notAvailableHindi = SharedAssetManager.Instance.GetTextureFromName("ScissorsNotAvailableHindi");
            ...
            {
                _scissorsComponent.SetTextures(open, closed, msg, notAvailableHindi);
            }
        ...
        {
            Vector2 screenCentre = new Vector2(90, 920);
        ...
        private void GameTimeout(GameTime gameTime)
        {
            ...
            _timeToSkip -= gameTime.GetElapsedSeconds();
            if (_timeToSkip < 0)
            {
                if (!_leavingToNextState)
                {
                    _isWavedInGame = true;
                    if (_isAttractScreenVisible)
                    {
                        GameManager.Instance.GotoPhase(GamePhase.THANKS);
                        _isAttractScreenVisible = false;
                        _leavingToNextState = true;
                    }
                }
            }
        ...
        public override void DrawSecondScreenInner(GameTime gameTime)
        {
            ...
            if (_movementAllowed)
            {
                ...
                DrawSpline(); // :H: Draws the overlays which will show the pam position
            }
            else
            {
                DrawStandard();
        ...
        private void DrawChallengeText()
        {
            var level = GameManager.Instance.CurrentLevel;
            var tex = SharedAssetManager.Instance.GetLevelNameGame(level, true);
            var challengeText = SharedAssetManager.Instance.GetChallengeText();
            var origin = new Vector2(tex.Width / 2f, tex.Height / 2f);
            Rectangle rect = new Rectangle(200, 675, 270, 60);
            Rectangle rectText = new Rectangle(200, 950, 270, 60);
            ...
            if (tex != null)
            {
                ...
                Game._spriteBatch.Draw(challengeText, rectText, null, Microsoft.Xna.Framework.Color.White, rot, origin, Microsoft.Xna.Framework.Graphics.SpriteEffects.None, 0);
            }
        }
